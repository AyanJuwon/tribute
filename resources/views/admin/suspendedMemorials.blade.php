...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">Manage Suspended Memorials</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">All Suspended Memorials</li>
                </ol>
            </div>
        </div>
        <!-- End Page Header -->
                            ...
                            <table class="table" id="example1">
                                ...
                                @foreach($memorials as $mem)
                                    <tr>
                                        ...
                                        <td>
                                            <span style="background-color: #dc3545" class="badge badge-success">Suspended</span>
                                        </td>
                                        <td>

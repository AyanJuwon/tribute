            ...
            <div class="col-sm-12 col-md-12 col-xl-12">
                <div class="card custom-card">
                    <div class="card-body text-center">
                        ...
                        <p class="mb-1 text-muted">Total Number of Users</p>
                        <h3 class="mb-0">{{ number_format(\App\User::userCount()) }}</h3>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group btn-hspace text-center">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    <a class="dropdown-item" href="{{route('user.show', $user->id)}}">View User</a>
                                                @if($user->isBan == 1)

        ...
        <div class="page-header">
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Banned Tributes</li>
                </ol>
            </div>
        </div>
        <!-- End Page Header -->
                                ...
                                <div class="col-sm-12 col-md-12 col-xl-12">
                                    <div class="card custom-card">
                                        <div class="card-body text-center">
                                            ...
                                            <p class="mb-1 text-muted">Total Banned Tributes</p>
                                            <h3 class="mb-0">{{ number_format(\App\Tribute::bannedTributes()) }}</h3>
                                        </div>
                                    </div>
                                </div>
{{--        </div>--}}
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div>
                            <h2 class="card-title mb-5" style="font-size: 30px">Banned Tributes</h2>

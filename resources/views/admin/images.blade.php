                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group btn-hspace text-center">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    <a class="dropdown-item" onclick="handleDelete('{{ $image->id }}')">Delete</a>
                                                    <a class="dropdown-item" onclick="handleDeletee('{{ $image->id }}')">Ban</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
@section('script')
    ...
    <script>
        function handleDeletee(id){
            $('#deactivateImageModal').modal({backdrop: 'static',keyboard : false});
            var form = document.getElementById('deactivateImageForm');
            var url = '{{ route('image.deactivate', [':id']) }}';
            url = url.replace(':id', id);
            form.action = url;
        }
    </script>

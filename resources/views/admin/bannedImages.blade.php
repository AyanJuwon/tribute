        ...
        <div class="page-header">
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Banned Images</li>
                </ol>
            </div>
        </div>
        <!-- End Page Header -->
            ...
            <div class="col-sm-12 col-md-12 col-xl-12">
                <div class="card custom-card">
                    <div class="card-body text-center">
                        ...
                        <p class="mb-1 text-muted">Total Number of Images</p>
                        <h3 class="mb-0">{{ number_format(\App\AddImages::bannedImages()) }}</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div>
                            <h2 class="card-title mb-5" style="font-size: 30px">Images</h2>
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group btn-hspace text-center">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item" onclick="handleDeletee('{{ $image->id }}')">Delete</a>
                                                <a class="dropdown-item" onclick="handleDelete('{{ $image->id }}')">Unban</a>
                                            </div>
                                        </div>
                                    </td>
                                    </tr>
...
@section('script')
    ...
    <script>
        function handleDelete(id){
            $('#activateImageModal').modal({backdrop: 'static',keyboard : false});
            var form = document.getElementById('activateImageForm');
            var url = '{{ route('image.activate', [':id']) }}';

...
@section('content')
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">Admins</h2>
                <ol class="breadcrumb">
            ...
            <div class="col-sm-12 col-md-12 col-xl-12">
                <div class="card custom-card">
                    <div class="card-body text-center">
                        ...
                        <p class="mb-1 text-muted">Total Number of Admins</p>
                        <h3 class="mb-0">{{ number_format(\App\User::adminCount()) }}</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card custom-card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div>
                            <h2 class="card-title mb-5" style="font-size: 30px">Admins</h2>
                            ...
                            <table class="table" id="example1">
                                ...
                                @foreach($admins as $user)
                                    <tr>
                                        ...
                                        <td>{{ $user->email }}</td>
                                        @if($user->isBan == false)
                                            <td><span style="background-color: #28a745" class="badge badge-success">Active</span></td>
                                        @endif

        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <form class="contact-form margin-bottom-30" id="contactForm" action="{{ route('update', auth()->user()->id) }}" method="post">
                        @csrf
                        ...
                        <input name="name" id="senderName" type="text" placeholder="Name" required="required" value="{{$user->name}}" />
                        <input type="email" name="email" id="senderEmail" placeholder="Email address" value="{{$user->email}}" required="required" />
{{--                        <input type="password" name="password" id="senderEmail" placeholder="Password" required="required" />--}}
